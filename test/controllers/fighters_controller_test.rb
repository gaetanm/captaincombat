...
class FightersControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create fighter" do
    assert_difference('Fighter.count') do
      post fighters_url, params: { fighter: { attack: @fighter.attack, health: @fighter.health, name: @fighter.name } }
    end
  ...
  test "should update fighter" do
    patch fighter_url(@fighter), params: { fighter: { attack: @fighter.attack, health: @fighter.health, name: @fighter.name } }
